...
{
    public class DataIngestion : IClassFixture<ODataTestFixture>
    {
        private readonly ODataTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(ODataTestFixture fixture, ITestOutputHelper output)
        {
