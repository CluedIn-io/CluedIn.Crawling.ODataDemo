...
namespace CluedIn.Crawling.OData.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IODataClientFactory>().AsFactory())
                .Register(Component.For<ODataClient>().LifestyleTransient());
